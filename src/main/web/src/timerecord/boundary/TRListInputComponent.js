...
export default class TRListInputComponent extends AbstractWebComponent {
  async init() {
  ...
  static register() {
    if (!customElements.get("t11-tr-list-input")) {
      customElements.define("t11-tr-list-input", TRListInputComponent);
    }
  }
}
TRListInputComponent.register();
