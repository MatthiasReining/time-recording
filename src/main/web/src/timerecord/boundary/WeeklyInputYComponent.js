...
export default class WeeklyInputYComponent extends AbstractWebComponent {
  async init() {
  ...
  static register() {
    if (!customElements.get("t11-weekly-input-y")) {
      customElements.define("t11-weekly-input-y", WeeklyInputYComponent);
    }
  }
}
